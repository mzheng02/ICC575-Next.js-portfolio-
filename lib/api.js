    ...
    const projectsList = [
        {
            ...
            genre: "Journalism",
            image: "01.jpg",
            content: "this is the main content for p1"
        },
        {
            title: "Project 2",
            slug: "project-2",
            genre: "Advertising",
            image: "02.jpg",
            content: "this is the main content for p2"
        },
        {
            title: "Project 3",
            slug: "project-3",
            genre: "Data Science",
            image: "03.jpg",
            content: "this is the main content for p3"
        },
        {
          title: "Project 4",
          slug: "project-4",
          genre: "Data Science",
          image: "04.jpg",
          content: "this is the main content for p4"
      },
      {
        title: "Project 5",
        slug: "project-5",
        genre: "Data Science",
        image: "05.jpg",
        content: "this is the main content for p5"
    },
    ];
    return projectsList;
}
...
export function filterProjectsByGenre(projectsList, activeGenre){
    ...
    if (activeGenre === "All") {
        ...
        filteredProjects = projectsList.filter((projectItem) => {
            ...
            return activeGenre === projectItem.node.catagories.edges[0].node.slug;
        });
